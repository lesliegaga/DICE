...
flags.DEFINE_enum('dataset', 'ml10m', ['ml10m', 'nf', 'amazonbook', 'movielens', 'yelp', 'lastfm', 'lastfm55', 'lastfm991'], 'Dataset.')
...
flags.DEFINE_multi_integer('topk', [20], 'Topk for testing recommendation performance.')
